...
// 구현한다.
public class GraphicTest02 extends Panel implements Runnable{
	...
	public static void main(String[] args) {
		...
		GraphicTest02 graphic = new GraphicTest02();
		frame.add(graphic);
	...
	public void run() {
		...
		while(true){
			...
			//Panel 클래스를 상속받아 작성한 paint() 메소드를 다시 실행하면 화면을 지우고 다시 그린다
			repaint();			
		}
